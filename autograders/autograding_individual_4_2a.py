...
"""
    ...
    Project_4/         [..] 
        test_data/
            ...
            Problem 4/
        your_solutions/    [.]   
            autograding_individual_4_2a.py   <--- Place here.
            Problem_2/
            ...
...
def autograde_p2(in_this_dir, in_test_dir, in_student_name, debug):
...
def grade_problem_2(student_dir, t_output, t_res, incommand, exact, debug):
    global is_missing
    global is_made
...
if __name__ == "__main__":
    print(G + "Autograding for Project 4 Problem 2:" + W + '\n')
    res = autograde_p2(ind_this_dir, ind_test_dir, ind_student_name, DEBUG)
