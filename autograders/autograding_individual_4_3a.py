...
"""
    ~~~~~~~~~~~~~~~~~ Project 4_3   ver 4_3a ~~~~~~~~~~~~~~~~~
    This file will run problem 3 of Project 4 ONLY!
    ...
    RUN LIKE: python or python3 autograding_individual_4_3a.py
    ...
    Project_4/         [..] 
        test_data/
            ...
            Problem 4/
        your_solutions/    [.]   
            autograding_individual_4_3a.py   <--- Place here.
            Problem_3/
            ...
...
def autograde_p3(in_this_dir, in_test_dir, in_student_name, debug):
    ...
    # Problem 3 ####################
    # expected input
    t_dir = test_dir + "/Problem 3/"
    t_p3_in = [
        t_dir + "mat_input.csv"
    ]
    # expected output
    t_p3_out = [
        t_dir + "mat_p3_output.csv"
    ]

    # actual program output
    t_dir = this_dir + "/Problem_3/"
    t_p3_get = [
        t_dir + "results.csv",
    ]
    t_p3_tim = [
...
def grade_problem_3(student_dir, t_output, t_res, incommand, exact, debug):
    global is_missing
    global is_made
...
if __name__ == "__main__":
    print(G + "Autograding for Project 4 Problem 3:" + W + '\n')
    res = autograde_p3(ind_this_dir, ind_test_dir, ind_student_name, DEBUG)
